...
public class Iso8601TimeStampFormat extends DateFormat {
    ...
    public static void main(String[] args) throws Exception{
        ...
        System.out.println(stdDateFormat.parse("2020-01-27T13:54:51Z"));
        System.out.println(ISO8601Utils.parse("2020-01-27T13:54:51Z"));


        System.out.println(format.parse("2019-12-19T16:03:37.263+00:00"));
        System.out.println(stdDateFormat.parse("2019-12-19T16:03:37.263+00:00"));
        System.out.println(ISO8601Utils.parse("2019-12-19T16:03:37.263+00:00"));


        System.out.println(format.parse("2020-03-25T10:03:10.025-05:00"));
        System.out.println(stdDateFormat.parse("2020-03-25T10:03:10.025-05:00"));
        System.out.println(ISO8601Utils.parse("2020-03-25T10:03:10.025-05:00"));
